<?php $page_title = 'Editar Área Común'; ?>
<?php include APP_PATH . '/views/layouts/header.php'; ?>

<div class="row">
    <div class="col-12">
        <h1><i class="fas fa-edit"></i> Editar Área Común</h1>
    </div>
</div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?= APP_URL ?>/common-areas/edit/<?= $area['id'] ?>" class="needs-validation" novalidate>
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="estado" name="estado" required>
                            <?= getCatalogOptions(COMMON_AREA_STATUSES, $area['estado']) ?>
                        </select>
                    </div>
