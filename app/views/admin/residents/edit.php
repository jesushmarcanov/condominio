<?php $page_title = 'Editar Residente'; ?>
<?php include APP_PATH . '/views/layouts/header.php'; ?>

<div class="row">
    <div class="col-12">
        <h1><i class="fas fa-user-edit"></i> Editar Residente</h1>
    </div>
</div>
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-home"></i> Editar Datos del Residente</h5>
            </div>
            <div class="card-body">
                <?php if(isset($errors)): ?>
                ...
                <form method="POST" action="<?= APP_URL ?>/residents/edit/<?= $resident['id'] ?>" class="needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" 
                                       value="<?= $resident['nombre'] ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="apartamento" name="apartamento" 
                                       value="<?= $resident['apartamento'] ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="piso" name="piso" 
                                       value="<?= $resident['piso'] ?>" min="1" max="50" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="fecha_ingreso" name="fecha_ingreso" 
                                       value="<?= $resident['fecha_ingreso'] ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="estado" name="estado">
                                    <option value="activo" <?= $resident['estado'] == 'activo' ? 'selected' : '' ?>>Activo</option>
                                    <option value="inactivo" <?= $resident['estado'] == 'inactivo' ? 'selected' : '' ?>>Inactivo</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <a href="<?= APP_URL ?>/residents/show/<?= $resident['id'] ?>" class="btn btn-outline-info">
...
function confirmDelete() {
    if(confirm(`¿Está seguro de que desea eliminar al residente "<?= $resident['nombre'] ?>"? Esta acción no se puede deshacer.`)) {
        window.location.href = `<?= APP_URL ?>/residents/delete/<?= $resident['id'] ?>`;
    }
}
</script>
