<?php $page_title = 'Editar Cuenta Bancaria'; ?>
<?php include APP_PATH . '/views/layouts/header.php'; ?>

<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-edit"></i> Editar Cuenta Bancaria</h1>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?= APP_URL ?>/bank-accounts/edit/<?= $account['id'] ?>" class="needs-validation" novalidate>
                    <?= csrf_field() ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="banco" name="banco" required>
                                    ...
                                    <?= getCatalogOptions(BANCOS_VENEZUELA, $account['banco'], false) ?>
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="numero_cuenta" name="numero_cuenta"
                               value="<?= htmlspecialchars($account['numero_cuenta']) ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="titular" name="titular"
                               value="<?= htmlspecialchars($account['titular']) ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pago_movil_telefono" name="pago_movil_telefono"
                                       value="<?= htmlspecialchars($account['pago_movil_telefono'] ?? '') ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pago_movil_cedula" name="pago_movil_cedula"
                                       value="<?= htmlspecialchars($account['pago_movil_cedula'] ?? '') ?>"
